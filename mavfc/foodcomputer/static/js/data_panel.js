...
for (i=0;i<columns.length;i++){
    ...
    //console.log("is an actuator");
		as[columns[i]] = d3.scale.linear().range([height, -1*(10+10*aspot)]);
		aspot++;
	} else if (columns[i].localeCompare("date") == 0){
    //console.log("this is the date");
		continue;
	} else {
  	//console.log("is a sensor");
